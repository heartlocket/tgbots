...
def generate_message():
    response = openai.ChatCompletion.create(
        ...
        messages=[
            ...
            {
                "role": "user", 
                "content": "Please write a lively tweet entirely in Japanese using lots of emojis hyping up the FIJI NFTs for World Peace Coin, include the cashtag '$WPC', and mention the NFTs are created by the artists behind Sproto Gremlins. You must keep your tweet under 200 characters."
            }
        ],
        max_tokens=100
    )
